...
class ChatPanel extends StatelessWidget {
    ...
    return Obx(() {
      return Row(
        children: [
          ...
          IconButton(
            onPressed: () => _showSystemPromptDialog(context, systemPromptController),
  ...
  void _showSystemPromptDialog(BuildContext context, SystemPromptController controller) {
                    ...
                    child: Row(
                      children: [
                        ...
                        if (prompt.enableVariables)
                          Chip(
                            label: Text('支持变量', style: TextStyle(fontSize: 10)),
